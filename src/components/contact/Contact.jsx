...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_5fn9rb5', 'template_jpx274v', form.current, '9RR-FfEgTmNMy5rcd')
     e.target.reset();
  };
                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">naim.cse17@gmail.com</span>
                        ...
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">+880-1816-037827</span>
                            <a href="https://api.whatsapp.com/send?phone=+8801816037827&text=Hello, more information!" className="contact_button">Write Me{" "} <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                        ...
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">naimur.durjoy/37</span>
